...
summon minecraft:armor_stand ~ ~ ~ {Tags:["rend_vortex_inner"],Invulnerable:1b,Invisible:1b}
summon minecraft:armor_stand ~ ~ ~ {Tags:["rend_vortex_outer"],Invulnerable:1b,Invisible:1b}