summon minecraft:armor_stand ~ ~ ~ {Tags:["rend_vortex_inner"],Invulnerable:1b,NoGravity:1b}
summon minecraft:armor_stand ~ ~ ~ {Tags:["rend_vortex_outer"],Invulnerable:1b,NoGravity:1b}
