...
scoreboard players operation @s rend.faded_husk.percent_reduction = @s rend.faded_husk.prev_xp_level 
scoreboard players operation @s rend.faded_husk.percent_reduction *= @s rend.faded_husk.HEALTH_GRADIENT
execute store result storage minecraft:rend faded_husk.health_modifier double 0.01 run scoreboard players operation @s rend.faded_husk.percent_reduction += @s rend.faded_husk.HEALTH_Y_MOD

#Calculate attack damage modifier (y=5/30x-5)
scoreboard players operation @s rend.faded_husk.percent_reduction = @s rend.faded_husk.prev_xp_level 
scoreboard players operation @s rend.faded_husk.percent_reduction *= @s rend.faded_husk.ATTACK_GRADIENT
execute store result storage minecraft:rend faded_husk.attack_modifier double 0.01 run scoreboard players operation @s rend.faded_husk.percent_reduction += @s rend.faded_husk.ATTACK_Y_MOD
