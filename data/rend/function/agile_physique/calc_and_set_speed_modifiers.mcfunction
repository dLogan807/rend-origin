...
#Calculate speed modifier (y=2x+100)
...
execute store result storage minecraft:rend agile_phys.speed_modifier double 0.001 run scoreboard players operation @s rend.agile_phys.speed_calc += @s rend.agile_phys.SPEED_Y_MOD
