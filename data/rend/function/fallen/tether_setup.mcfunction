#Summon model
execute rotated ~180 0 run function animated_java:rend_fallen_tether/summon {args: {}}
#Record current y-level
execute store result storage minecraft:rend tether_position.y_store double 1 run data get entity @s Pos[1] 1000
